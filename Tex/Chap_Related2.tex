...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.60\textwidth]{2_dataflow_dag}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.60\textwidth]{2_storm_topo}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.40\textwidth]{2_samza_job}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.60\textwidth]{2_samza_dag}
