...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.60\textwidth]{4_star-d-runtime}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.60\textwidth]{4_star-d_task_stat}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.60\textwidth]{4_star-d_worker_stat}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.80\textwidth]{4_star-d_example_100}
